...
namespace Robot_Control.Input
{
    class GamepadInterface
    {
        ...
        private void changeOptions(object sender, OptionEventArgs e)
        {
            analog.option = e.option;
        }
        ...
        public void addMenu(ToolStripMenuItem m)
        {
            ...
            gamepadMenu.ChangeOptionsEvent += changeOptions;
        }
    ...
    class GamepadMenu
    {
        ...
        public event EventHandler<OptionEventArgs> ChangeOptionsEvent;
        private GamepadXBox gamepad;
        private bool enabled;
        ...
        private ToolStripMenuItem _options;
        private ToolStripMenuItem _boost;
        private ToolStripMenuItem _exponential;
        ...
        protected virtual void onChangeOptions(Option o)
        {
            ChangeOptionsEvent?.Invoke(this, new OptionEventArgs(o));
        }
        ...
        private void optionBoost(object sender, EventArgs e)
        {
            _boost.Checked = !_boost.Checked;
            if (_boost.Checked)
                onChangeOptions(Option.BoostOn);
            else
                onChangeOptions(Option.BoostOff);
        }

        private void optionExponential(object sender, EventArgs e)
        {
            _exponential.Checked = !_exponential.Checked;
            if (_exponential.Checked)
                onChangeOptions(Option.ExpOn);
            else
                onChangeOptions(Option.ExpOff);
        }
    }
